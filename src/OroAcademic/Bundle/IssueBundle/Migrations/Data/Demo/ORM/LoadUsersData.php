...
class LoadUsersData extends AbstractFixture implements ContainerAwareInterface
{
    ...
    protected function initSupportingEntities(ObjectManager $manager = null)
    {
        ...
        $this->role = $this->em->getRepository('OroUserBundle:Role')->findOneBy(['role' => 'ROLE_MANAGER']);
        $this->businessUnit = $manager->getRepository('OroOrganizationBundle:BusinessUnit')->getFirst();
    }
    ...
    private function loadDictionary($name)
    {
        ...
        $dictionaryDir = $this->container
            ->get('kernel')
            ->locateResource('@OroAcademicIssueBundle/Migrations/Data/Demo/ORM/dictionaries');
